...
import de.amit.battlequest.user.service.user.PasswordService;
...
public class PasswordController {
	...
	public ResponseEntity<String> update(@PathVariable UUID uuid, @RequestBody Credentials credentials) {
		...
		if (user.getUsername().equals(credentials.getUsername())) return passwordService.update(user, credentials.getPassword());
